...
public class MarshallerBean implements Marshaller.MarshallerLocal, Marshaller.MarshallerRemote
{
	...
	@Override
	public MarshallJavaObjectToXmlResponse marshallJavaObjectToXml(MarshallJavaObjectToXmlRequest marshallJavaObjectToXmlRequest)
			throws RequestNotValidException, JavaObjectOrBoundClassesNotValidException
	{
		...
		try
		{
			...
			if ((marshallJavaObjectToXmlRequest.getFormatXml() != null) && (marshallJavaObjectToXmlRequest.getFormatXml()))
			{
