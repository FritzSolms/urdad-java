...
/** Introduces the concept of an error occurring when a user of a service is not permitted to do so. */
@XmlRootElement
@XmlType
@XmlAccessorType(XmlAccessType.PROPERTY)
@JsonTypeName("org.urdad.services.ServiceUsageNotAuthorisedError")
public class ServiceUsageNotAuthorisedError extends RuntimeException
{

	public ServiceUsageNotAuthorisedError(){}
     ...
     */
    public ServiceUsageNotAuthorisedError(String message)
    {
        super(message);
    }
     ...
     */
    public ServiceUsageNotAuthorisedError(String message, Throwable cause)
    {
        super(message, cause);
    }
     ...
     * @param cause the cause.
     */
    public ServiceUsageNotAuthorisedError(Throwable cause)
    {
        super(cause);
    }
