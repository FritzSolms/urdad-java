...
public class UnmarshallerBean implements Unmarshaller.UnmarshallerLocal, Unmarshaller.UnmarshallerRemote
{
    ...
    @Override
    public UnmarshallJsonToJavaObjectResponse unmarshallJsonToJavaObject(UnmarshallJsonToJavaObjectRequest
    ...
    private static final Logger logger = LoggerFactory.getLogger(UnmarshallerBean.class);
    @Inject
