...
@JsonTypeName("org.urdad.events.services.ServiceResultNotReceivedEvent")
@JsonIgnoreProperties(ignoreUnknown = true)
public class ServiceResultNotReceivedEvent extends ServiceEvent
{

	/** Default constructor. */
	public ServiceResultNotReceivedEvent()
	{
		super();
	}

	/** Convenience constructor. */
	public ServiceResultNotReceivedEvent(String serviceProviderType, String serviceProviderIdentifier, String service,
	...
	/** Convenience constructor. */
	public ServiceResultNotReceivedEvent(String serviceProviderType, String serviceProviderIdentifier, String service,
		String requestIdentifier, String elaboration)
	{
		super(serviceProviderType, serviceProviderIdentifier, service);
		this.requestIdentifier = requestIdentifier;
